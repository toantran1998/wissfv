...
return array(
	'id'     => 'naxly_banner_settings',
	'title'  => esc_html__( "Naxly Banner Settings", "konia" ),
	'fields' => array(
		array(
			'id'      => 'banner_source_type',
			'type'    => 'button_set',
			'title'   => esc_html__( 'Banner Source Type', 'naxly' ),
			'options' => array(
		...
		array(
			...
			'default'  => array(
				'url' => NAXLY_URI . 'assets/images/shape/shape-62.png',
			),
			'required' => array( 'banner_page_banner', '=', true ),
		),
	),
