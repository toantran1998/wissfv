 ...
 * @since 1.0.0
 */
class Testimonials_V5 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials V5', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v5',
			[
				'label' => esc_html__( 'Testimonials V5', 'naxly' ),
			]
		);
		$this->add_control(
			'text_limit',
                        ...
                        <div class="testimonial-content">
                            <div class="inner-box">
                                ...
                                <div class="content-box">
                                    <div class="icon-box" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/icons/icon-5.png);"></div>
                                    <div class="text">
