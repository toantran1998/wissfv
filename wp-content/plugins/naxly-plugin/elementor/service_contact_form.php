 ...
 * @since 1.0.0
 */
class Service_Contact_Form extends Widget_Base {
	...
	public function get_name() {
		return 'naxly_service_contact_form';
	}
	...
	public function get_title() {
		return esc_html__( 'Service Contact Form', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Service Contact Form', 'naxly' ),
			]
		);
		$this->add_control(
			'subtitle',
			[
				...
				'placeholder' => __( 'Contact Us', 'elementor' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <section class="contact-section alternate-3">
            <div class="pattern-layer" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-48.png);"></div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image-box wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <figure class="image js-tilt"><img src="<?php echo esc_url($settings['feature_img']['url']);?>" alt="<?php esc_attr_e('Awesome Image', 'naxly'); ?>"></figure>
                        </div>
                    </div>
                </div>
            </div>
