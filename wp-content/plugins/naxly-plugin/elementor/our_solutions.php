...
class Our_Solutions extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Solutions', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_solutions',
			[
				'label' => esc_html__( 'Our Solutions', 'naxly' ),
			]
		);
		$this->add_control(
			'subtitle',
			[
				...
				'default'     => __( 'More than Solutions', 'elementor' ),
			]
		);
		$this->add_control(
			'title',
		...
		$this->add_control(
              'services', 
			  	[
            		...
            		'default' => 
						[
                			['block_title' => esc_html__('Data Science', 'diaco')],
                			['block_title' => esc_html__('Machine Learning', 'diaco')],
                			['block_title' => esc_html__('Artificial Intelligence', 'diaco')],
							['block_title' => esc_html__('Data Warehousing', 'diaco')]
            			],
            		'fields' => 
						[
                			[
							...
							[
                    			...
                    			'type' => Controls_Manager::TEXT,
                    			'default' => esc_html__('Read More', 'diaco')
                			],
							[
                    			'name' => 'ext_link',
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 block-column">
                        ...
                        <div class="service-block-five wow fadeInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <figure class="image-box"><img src="<?php echo esc_url($item['feature_img']['url']);?>" alt="<?php esc_attr_e('Awesome Image', 'naxly'); ?>"></figure>
                                <div class="link"><a href="<?php echo esc_url($item['ext_link']['url']);?>" class="btn-style-four"><?php echo wp_kses($item['btn_title'], true);?><span><?php esc_html_e('+', 'naxly'); ?></span></a></div>
                            </div>
                        </div>
