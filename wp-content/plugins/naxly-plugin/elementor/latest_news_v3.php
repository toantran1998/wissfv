...
class Latest_News_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News v3', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news_v3',
			[
				'label' => esc_html__( 'Latest News V3', 'naxly' ),
			]
		);
		$this->add_control(
			'subtitle',
            ...
            <div class="auto-container">
                ...
                <div class="upper-box clearfix mb-40">
                    ...
                    <div class="btn-box pull-right mt-60">
                        <a href="<?php echo esc_url( $settings['btn_link']['url'] );?>" class="btn-style-eight"><?php echo wp_kses( $settings['btn_title'], $allowed_tags );?></a>
                    </div>
                </div>
                <?php endif; ?>
