...
class Team_Carousel extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Team Carousel', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'team_carousel',
			[
				'label' => esc_html__( 'Team Carousel', 'naxly' ),
			]
		);
		$this->add_control(
			'query_number',
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <ul class="contact-box clearfix">
                                    <li class="email">
                                        <a href="mailto:<?php echo sanitize_email(get_post_meta( get_the_id(), 'email_address'));?>">
                                            <i class="flaticon-gmail"></i>
                                            <span><?php echo sanitize_email(get_post_meta( get_the_id(), 'email_address', true ));?></span>
                                        </a>
                                    </li>
                                    <?php
