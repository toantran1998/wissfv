 ...
 * @since 1.0.0
 */
class Case_Studies_Carousel extends Widget_Base {
	...
	public function get_name() {
		return 'naxly_case_studies_carousel';
	}
	...
	public function get_title() {
		return esc_html__( 'Case Studies Carousel', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Case Studies Carousel', 'naxly' ),
			]
		);
		$this->add_control(
			'query_number',
