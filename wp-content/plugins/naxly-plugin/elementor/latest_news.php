...
class Latest_News extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news',
			[
				'label' => esc_html__( 'Latest News', 'naxly' ),
			]
		);
		$this->add_control(
			'shape_img1',
	...
	protected function render() {
        ...
        <!-- news-section -->
        <section class="news-section <?php if($settings['style_two']) echo 'sec-pad'; ?> <?php if($settings['rtl_style']) echo 'home_rtl'; ?>">
