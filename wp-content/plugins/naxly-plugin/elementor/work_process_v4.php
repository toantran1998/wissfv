 ...
 * @since 1.0.0
 */
class Work_Process_V4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Work Process V4', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'work_process_v4',
			[
				'label' => esc_html__( 'Work Process V4', 'naxly' ),
			]
		);
		$this->add_control(
			'bg_img',
        ...
        <section class="process-style-two alternate-2">
            ...
            <div class="auto-container">
                ...
                <div class="inner-content">
                    <div class="line" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/icons/line-3.png);"></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 work-block">
                            <div class="work-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="icon-box">
                                        <div class="border-line" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/icons/border-3.png);"></div>
