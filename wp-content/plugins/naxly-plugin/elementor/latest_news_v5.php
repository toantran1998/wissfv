...
class Latest_News_V5 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News V5', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news_v5',
			[
				'label' => esc_html__( 'Latest News V5', 'naxly' ),
			]
		);
		$this->add_control(
			'subtitle',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Company news & updates', 'elementor' ),
			]
		);
		$this->add_control(
			'text_limit',
	...
	protected function render() {
		...
		{ ?>
		<!-- news-section -->
        <section class="news-section <?php if($settings['style_two'] == 'two') echo 'sec-pad'; else echo 'style-five' ; ?>">
                    ...
                    <div class="news-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="link"><a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><?php esc_html_e('Read More', 'naxly'); ?><i class="flaticon-next"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <?php endwhile; ?>
