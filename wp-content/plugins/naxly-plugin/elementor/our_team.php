...
class Our_Team extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Team', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_team',
			[
				'label' => esc_html__( 'Our Team', 'naxly' ),
			]
		);
		$this->add_control(
			'subtitle',
		...
		$this->add_control(
			'style_two',
			[
				'label'   => esc_html__( 'Choose Different Style', 'naxly' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'Team Style One',
				'options' => array(
					'one' => esc_html__( 'Choose Team Style One', 'naxly' ),
					'two'  => esc_html__( 'Choose Team Style Two', 'naxly' ),
				),
			]
		);
	...
	protected function render() {
        ...
        <!-- team-section -->
        <section class="team-section <?php if($settings['style_two'] == 'two') echo 'alternate-2'; else echo ''; ?>">
            <div class="auto-container">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <?php the_post_thumbnail('naxly_245x250'); ?>
                                    <ul class="contact-box clearfix">
                                        <li class="email">
                                            <a href="mailto:<?php echo (get_post_meta( get_the_id(), 'email_address', true));?>">
                ...
                <div class="more-btn"><a href="<?php echo esc_url($settings['btn_link']['url']);?>" class="<?php if($settings['style_two'] == 'two') echo 'btn-style-four'; else echo 'btn-style-eight'; ?>"><?php echo wp_kses($settings['btn_title'], $allowed_tags);?></a></div>
            	<?php endif; ?>
