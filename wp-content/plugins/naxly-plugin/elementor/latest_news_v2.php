...
class Latest_News_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News V2', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news_v2',
			[
				'label' => esc_html__( 'Latest News V2', 'naxly' ),
			]
		);
		$this->add_control(
			'subtitle',
                        ...
                        <div class="news-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="link"><a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><i class="flaticon-next"></i><?php esc_html_e('More Details', 'naxly'); ?></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
