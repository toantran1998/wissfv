...
class Funfacts extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Funfacts', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'funfacts',
			[
				'label' => esc_html__( 'Funfacts', 'naxly' ),
			]
		);
		$this->add_control(
              'funfact', 
			  	[
            		...
            		'default' => 
						[
                			...
                			['block_title' => esc_html__('Expert Scientists', 'diaco')]
            			],
            		'fields' => 
						[
                			[
	...
	protected function render() {
        ...
        <!-- fun-fact -->
        <section class="fun-fact <?php if($settings['rtl_style']) echo 'home_rtl'; ?>">
