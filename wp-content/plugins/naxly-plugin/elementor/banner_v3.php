...
class Banner_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Banner V3', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'banner_v3',
			[
				'label' => esc_html__( 'Banner V3', 'naxly' ),
			]
		);
		$this->add_control(
			'shape_image',
				[
				  'label' => __( 'Banner Shape Image', 'diaco' ),
		...
		$this->add_control(
			'btn_title_2',
			[
				'label'       => __( 'Button Title Two', 'elementor' ),
				'type'        => Controls_Manager::TEXT,
				'dynamic'     => [
					'active' => true,
				],
                ...
                <div class="row clearfix align-items-center">
                    <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                        <div class="content-box">
                            ...
                            <div class="btn-box">
                                <a href="<?php echo esc_url( $settings['btn_link']['url'] );?>" class="theme-btn style-seven"><i class="flaticon-next"></i><?php echo wp_kses( $settings['btn_title'], true );?></a>
                                <a href="<?php echo esc_url( $settings['btn_link_2']['url'] );?>" class="theme-btn style-six"><?php echo wp_kses( $settings['btn_title_2'], true );?></a>
                            </div>
                        </div>
                    </div>
                </div>
