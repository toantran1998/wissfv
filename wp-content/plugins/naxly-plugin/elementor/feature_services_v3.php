...
class Feature_Services_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'naxly_feature_services_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature Services V3', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature_services_v3',
			[
				'label' => esc_html__( 'Feature Services V3', 'naxly' ),
			]
		);
		$this->add_control(
			'subtitle',
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 welcome-block">
                        <div class="welcome-block-one wow slideInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><?php the_post_thumbnail('naxly_136x143'); ?></figure>
                                    <div class="bg-pattern" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/icons/icon-bg-6.png);"></div>
                                    <div class="overlay-pattern" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/icons/icon-bg-7.png);"></div>
                                </div>
