...
class Testimonials_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials V3', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v3',
			[
				'label' => esc_html__( 'Testimonials V3', 'naxly' ),
			]
		);
		$this->add_control(
			'bg_img',
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 thumb-column">
                                    <div class="slider-pager">
                                        ...
                                        <ul class="thumb-box">
                                            ...
                                            <li>
                                                <a class="<?php if($counts == 1) echo 'active'; ?>" data-slide-index="<?php echo esc_attr($count); ?>" href="#">
                                                    <figure class="thumb thumb-<?php echo esc_attr($counts); ?>"><?php the_post_thumbnail('naxly_180x180'); ?></figure>
                                                </a>
                                            </li>
