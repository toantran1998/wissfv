...
class Our_Services_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Services V2', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_services_v2',
			[
				'label' => esc_html__( 'Our Services V2', 'naxly' ),
			]
		);
		$this->add_control(
			'bg_shape_image',
                        ...
                        <div class="service-block-four">
                            <div class="inner-box">
                                ...
                                <div class="pattern-box">
                                    <div class="bg-pattern" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-39.png);"></div>
                                    <div class="overlay-pattern" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-40.png);"></div>
                                </div>
                                <figure class="image-box"><?php the_post_thumbnail('naxly_225x215'); ?></figure>
