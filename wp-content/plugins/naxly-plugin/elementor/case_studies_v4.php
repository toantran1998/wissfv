 ...
 * @since 1.0.0
 */
class Case_Studies_V4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Case Studies V4', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'case_studies_v4',
			[
				'label' => esc_html__( 'Case Studies V4', 'naxly' ),
			]
		);
		$this->add_control(
			'subtitle',
                    ...
                    <div class="case-block-two">
                        <div class="inner-box">
                            <figure class="image-box">
                                <?php the_post_thumbnail('naxly_570x400'); ?>
