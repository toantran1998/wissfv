 ...
 * @since 1.0.0
 */
class Blog_Masonry extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog Masonry', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'blog_masonry',
			[
				'label' => esc_html__( 'Blog Masonry', 'naxly' ),
			]
		);
		$this->add_control(
			'text_limit',
	...
	protected function render() {
        ...
        <section class="blog-masonry">
            <div class="auto-container">
                <div class="sortable-masonry">
                    <div class="items-container row clearfix">
                        <?php while ( $query->have_posts() ) : $query->the_post(); 
							...
							if ( $format == 'quote' ) :
						?>
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column news-block">
                            <div class="news-block-one news-block-three wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                            ...
                            <div class="news-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div class="inner-box">
                                    <figure class="image-box">
                                        <?php if(naxly_set(get_post_meta( get_the_id()), 'dimension', true) == 'extra_height')
											$image_size = 'naxly_370x520'; 
										  elseif(naxly_set(get_post_meta( get_the_id()), 'dimension', true) == 'medium_height')
											$image_size = 'naxly_370x350'; 
										  else
											$image_size = 'naxly_370x250'; 
                ...
                <div class="more-btn"><a href="<?php echo esc_url( $settings['btn_link']['url'] );?>" class="theme-btn style-three"><?php echo wp_kses( $settings['btn_title'], $allowed_tags );?><span><?php esc_html_e('+', 'naxly'); ?></span></a></div>
            </div>
        </section>
        <!-- blog-masonry end -->	
