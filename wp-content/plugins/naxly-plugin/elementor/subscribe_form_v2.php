...
class Subscribe_Form_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'naxly_subscribe_form_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Subscribe Form V2', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'subscribe_form_v2',
			[
				'label' => esc_html__( 'Subscribe Form V2', 'naxly' ),
			]
		);
		$this->add_control(
			'image',
				[
				  'label' => __( 'Laptop Image', 'diaco' ),
	...
	protected function render() {
        ...
        <section class="subscribe-section">
            <div class="pattern-layer">
                <div class="pattern-1" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-29.png);"></div>
                <div class="pattern-2" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-30.png);"></div>
            </div>
            
            <figure class="image-layer float-bob-y"><img src="<?php echo $settings['image']['url'];?>" alt="<?php esc_html_e('Awesome Image', 'naxly'); ?>"></figure>
