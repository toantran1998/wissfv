 ...
 * @since 1.0.0
 */
class Our_Technology extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Technology', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_technology',
			[
				'label' => esc_html__( 'Our Technology', 'naxly' ),
			]
		);
		$this->add_control(
			'subtitle',
            ...
            <div class="auto-container">
                ...
                <div class="inner-content">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 technology-block">
                            <div class="technology-block-one">
                                <div class="inner-box">
                                    <div class="pattern-layer rotate-me" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-19.png);"></div>
