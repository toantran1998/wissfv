...
class Our_Projects_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Projects V3', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_projects_v3',
			[
				'label' => esc_html__( 'Our Projects V3', 'naxly' ),
			]
		);
		$this->add_control(
			'text_limit',
	...
	protected function render() {
		...
		<?php 
            ...
            <!-- case-studies -->
            <section class="case-studies project-page case-style-three">
