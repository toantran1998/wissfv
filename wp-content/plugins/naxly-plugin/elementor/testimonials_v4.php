...
class Testimonials_V4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonials V4', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonials_v4',
			[
				'label' => esc_html__( 'Testimonials V4', 'naxly' ),
			]
		);
		$this->add_control(
			'subtitle',
                ...
                <div class="inner-container">
                    <div class="testimonial-carousel-3 owl-carousel owl-theme owl-dots-none">
                        ...
                        <div class="testimonial-content">
                            <div class="inner-box">
                                <div class="upper-box">
                                    <figure class="logo-box"><img src="<?php echo esc_url($client_image['url']);?>" alt="<?php esc_attr_e('Awesome Image', 'naxly'); ?>"></figure>
                                ...
                                <div class="author-info">
                                    <figure class="image-box"><?php the_post_thumbnail('naxly_70x70'); ?></figure>
                                    <h4><?php the_title(); ?></h4>
