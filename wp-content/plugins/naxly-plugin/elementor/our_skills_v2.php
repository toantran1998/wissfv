...
class Our_Skills_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Skills V2', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_skills_v2',
			[
				'label' => esc_html__( 'Our Skills V2', 'naxly' ),
			]
		);
		$this->add_control(
			'img',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Skills & Facts', 'elementor' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <section class="skills-style-two">
            <div class="pattern-layer" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-27.png);"></div>
            <div class="anim-icon">
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image-box wow slideInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="image-bg" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/shape/shape-28.png);"></div>
