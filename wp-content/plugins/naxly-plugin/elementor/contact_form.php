...
class Contact_Form extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact Form', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'contact_form',
			[
				'label' => esc_html__( 'Contact Form', 'naxly' ),
			]
		);
		$this->add_control(
			'feature_img',
		...
		$this->add_control(
			'style_two',
			[
				'label'   => esc_html__( 'Choose Spacing Style', 'naxly' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'Spacing Style One',
				'options' => array(
	...
	protected function render() {
        ...
        <!-- contact-section -->
        <section class="contact-section <?php if($settings['style_two'] == 'two') echo 'alternate-2'; else echo ''; ?>">
