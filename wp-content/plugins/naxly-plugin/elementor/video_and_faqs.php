 ...
 * @since 1.0.0
 */
class Video_And_Faqs extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Video and Faqs', 'naxly' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'video_and_faqs',
			[
				'label' => esc_html__( 'Video and Faqs', 'naxly' ),
			]
		);
		$this->add_control(
			'shape_img',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'More Answers', 'elementor' ),
			]
		);
		$this->add_control(
			'btn_link',
		...
		$this->add_control(
              'accordion', 
			  	[
            		...
            		'default' => 
						[
                			['acc_title' => esc_html__('Enter Title', 'diaco')],
            			],
            		'fields' => 
						[
                			[
        ...
        <section class="video-faq">
            ...
            <div class="auto-container">
                <div class="video-inner">
                    <div class="video-box" style="background-image: url(<?php echo esc_url( $settings['video_img']['url']);?>);">
                        <div class="video-content">
                            <a href="<?php echo esc_url( $settings['video_url']['url']);?>" class="lightbox-image" data-caption=""><i class="flaticon-play-button"></i></a>
                            <h3><?php echo wp_kses( $settings['video_title'], true );?></h3>
                        </div>
                    </div>
                </div>
                <div class="faq-inner">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 content-column">
                            <div id="content_block_06">
                                <div class="content-box">
                                    ...
                                    <div class="btn-box"><a href="<?php echo esc_url( $settings['btn_link']['url'] );?>" class="btn-style-eight"><?php echo wp_kses( $settings['btn_title'], true );?></a></div>
                                </div>
                            </div>
                        </div>
