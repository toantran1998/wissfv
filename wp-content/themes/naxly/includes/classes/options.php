...
class Options {
	 ...
	 * @var string
	 */
	private $opt_name = NAXLY_NAME . '_options';
	...
	private $page_slug = NAXLY_NAME . '_options';
	...
	function init() {
		...
		$this->menu_title = esc_html__( 'NAXLY Options', 'naxly' );
		$this->page_title = esc_html__( 'NAXLY Options', 'naxly' );
	...
	function helpTabs() {
		...
		$tabs = array(
			array(
				'id'      => 'redux-help-tab-1',
				'title'   => esc_html__( 'Theme Information 1', 'naxly' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'naxly' ),
			),
			array(
				'id'      => 'redux-help-tab-2',
				'title'   => esc_html__( 'Theme Information 2', 'naxly' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'naxly' ),
			),
		);
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'naxly' ) . '</p>';
	...
	function sections() {
		...
		$sections_path = apply_filters( 'naxly_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "naxly_redux_sections_{$key}", $options );
