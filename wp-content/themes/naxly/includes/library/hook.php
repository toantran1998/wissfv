 ...
 */
function naxly_load_default_hooks() {

	$config = naxly_WSH()->config( 'default' );
...
/**
 * [naxly_main_header_area description]
 *
 * @return [type] [description]
 */


function naxly_main_header_area() {
...
// echo $header_e;exit;
	...
	if ( $header == 'header_v1' ) {
		naxly_template_load( 'templates/header/default-header.php' );
	} elseif ( $header == 'header_v2' ) {
		naxly_template_load( 'templates/header/header_v2.php' );
	} elseif ( $header == 'header_v3' ) {
		naxly_template_load( 'templates/header/header_v3.php' );
	} elseif ( $header == 'header_v4' ) {
		naxly_template_load( 'templates/header/header_v4.php' );
	} elseif ( $header == 'header_v5' ) {
		naxly_template_load( 'templates/header/header_v5.php' );
	} elseif ( $header == 'header_v6' ) {
		naxly_template_load( 'templates/header/header_v6.php' );
	} elseif ( $header == 'header_v7' ) {
		naxly_template_load( 'templates/header/header_v7.php' );
	} elseif ( $header == 'header_v8' ) {
		naxly_template_load( 'templates/header/header_v8.php' );
	} else {
		naxly_template_load( 'templates/header/header_v6.php' );
	}
}
...
/**
 * [naxly_main_footer_area description]
 *
 * @return [type] [description]
 */

function naxly_main_footer_area() {
...
// echo $footer_e;exit;
	...
	if ( $footer == 'footer_v1' ) {
		...
		naxly_template_load( 'templates/footer/footer_v2.php' );
	} elseif ( $footer == 'footer_v3' ) {
		naxly_template_load( 'templates/footer/footer_v3.php' );
	} elseif ( $footer == 'footer_v4' ) {
		naxly_template_load( 'templates/footer/footer_v4.php' );
	} elseif ( $footer == 'footer_v5' ) {
		naxly_template_load( 'templates/footer/footer_v5.php' );
	} elseif ( $footer == 'footer_v6' ) {
		naxly_template_load( 'templates/footer/footer_v6.php' );
	} else {
		naxly_template_load( 'templates/footer/footer_set.php' );
	}
}
...
/**
 * [naxly_sidebar description]
 *
 * @return [type] [description]
 */

function naxly_sidebar( $data ) {

	naxly_template_load( 'templates/sidebar.php', compact( 'data' ) );
}

/**
 * [naxly_banner description]
 *
 * @return [type] [description]
 */

function naxly_banner( $data ) {

	naxly_template_load( 'templates/banner/banner.php', compact( 'data' ) );
