        ...
        <div class="outer-box clearfix">
            ...
            <div class="menu-area pull-right clearfix">
                ...
                <div class="menu-right-content clearfix">
                    <?php if( $options->get('header_v7_phone') ):?><div class="phone"><h4><i class="flaticon-music"></i><a href="tel:<?php echo esc_url( $options->get( 'header_v7_phone' ));?>"><?php echo wp_kses( $options->get( 'header_v7_phone' ), $allowed_html );?></a></h4></div><?php endif; ?>
                    <?php if( $options->get('header_v7_search_icon') ):?>
