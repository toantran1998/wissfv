...
<header class="main-header style-four">
        ...
        <div class="header-top clearfix">
            <div class="top-left pull-left clearfix">
                <ul class="info-box clearfix">
                    <?php if( $options->get('header_v4_phone') ):?><li><i class="flaticon-music"></i><a href="tel:<?php echo esc_url( $options->get( 'header_v4_phone' ));?>"><?php echo wp_kses( $options->get( 'header_v4_phone' ), $allowed_html );?></a></li><?php endif; ?>
                	<?php if( $options->get('header_v4_email') ):?><li><i class="flaticon-gmail"></i><a href="mailto:<?php echo esc_url( $options->get( 'header_v4_email' ));?>"><?php echo wp_kses( $options->get( 'header_v4_email' ), $allowed_html );?></a></li><?php endif; ?>
                </ul>
            </div>
            <div class="top-right pull-right clearfix">
                <?php if( $options->get('header_v4_demo_link') ):?>
                <div class="request-btn"><i class="flaticon-next"></i><a href="<?php echo esc_url($options->get('header_v4_demo_link'));?>"><?php echo wp_kses($options->get('header_v4_demo_title'), $allowed_html);?></a></div>
                <?php endif; ?>
                
                <?php if( $options->get('header_v4_search_icon') ):?>
        ...
        <div class="auto-container">
            <div class="outer-box clearfix">
                <div class="logo-box pull-left">
                    <figure class="logo"><?php echo naxly_logo( $logo_type, $image_logo8, $logo_dimension8, $logo_text, $logo_typography ); ?></figure>
                </div>
    ...
    <div class="sticky-header">
        <div class="auto-container clearfix">
            <figure class="logo-box"><?php echo naxly_logo( $logo_type, $image_logo9, $logo_dimension9, $logo_text, $logo_typography ); ?></figure>
