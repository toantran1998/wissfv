...
<header class="main-header style-one home-1">
                ...
                <div class="outer-box">
                    ...
                    <div class="header-top clearfix">
                        <div class="top-right pull-right clearfix">
                            <?php if( $options->get('header_v1_phone') ):?>
                            <div class="support"><i class="flaticon-music"></i><span><?php esc_html_e('Start your project today', 'naxly'); ?></span><a href="tel:<?php echo esc_url($options->get( 'header_v1_phone' ));?>"><?php echo wp_kses($options->get( 'header_v1_phone' ), $allowed_html);?></a></div>
                            <?php endif;?>
                            ...
                            <?php if( $options->get('header_v1_search_icon') ):?>
                    ...
                    <div class="header-upper clearfix">
                        <div class="menu-area pull-right clearfix">
                            ...
                            <?php if( $options->get('header_v1_btn_link') ):?>
                   			<div class="btn-box">
                                <a href="<?php echo esc_url($options->get('header_v1_btn_link'));?>" class="theme-btn style-one"><?php echo wp_kses($options->get('header_v1_btn_title'), $allowed_html);?></a>
                            </div>
                            <?php endif;?>
                        </div>
                    </div>
    ...
    <div class="sticky-header">
        <div class="auto-container clearfix">
            <figure class="logo-box"><?php echo naxly_logo( $logo_type, $image_logo, $logo_dimension, $logo_text, $logo_typography ); ?></figure>
            <div class="menu-area">
